...
public class InternetVideoViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_internet_video_view);
        path = getIntent().getStringExtra("link");
        playerView = findViewById(R.id.playInternetVideo);
    }
    ...
    private MediaSource buildMediaSource(Uri uri) {
        ...
        return new ExtractorMediaSource.Factory(
                new DefaultHttpDataSourceFactory("custom")).
